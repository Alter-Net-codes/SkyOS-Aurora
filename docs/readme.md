...
## Install 
### Linux
Get the newest python release, download the source code of this project and run kernel.py: 
`python /home/<username>/path/to/SkyOS/kernel/kernel.py` 
### Windows
Install the newest python release and then download the source code of this project and run kernel.py: 
`C:\Users\<username>\path\to\SkyOS\kernel\kernel.py` 
### macOS
Download the source code of this project (You need to install newest python release since macOS only comes pre-installed with python2) and run kernel.py:
